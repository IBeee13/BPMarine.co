...
<section class="relative w-full overflow-hidden py-8">
    <div data-aos="custom-blur-up" class="relative px-6 md:px-11 lg:px-15 xl:px-21 z-10 w-full">
        ...
        <div class="flex flex-col md:flex-row md:items-center gap-3 md:gap-8">
            <h1 class="text-4xl sm:text-5xl md:text-5xl lg:text-8xl text-accent font-extrabold leading-tight whitespace-nowrap" 
...
{{-- Contact Section --}}
<section class="flex flex-col mt-[-32px] md:flex-row w-full px-6 md:px-11 lg:px-16 xl:px-22 pb-16 md:pb-20 items-start">
    {{-- Info Kontak --}}
    <div class="w-full md:w-1/2 bg-background border-2 border-b-0 md:border-b-2 md:border-r-0 border-accentsecond md:min-h-0 lg:min-h-120 overflow-hidden">
        <div data-aos="fade-up"
            ...
            <h1 class="text-lg md:text-xl lg:text-3xl text-primary font-medium">+62 821-3081-0592</h1>
        </div>
        <div data-aos="fade-up"
            class="flex flex-col justify-center border-b-2 border-accentsecond w-full p-4 md:p-5 lg:p-8 gap-1">
        ...
        <div data-aos="fade-up" class="flex flex-col justify-center w-full p-4 md:p-5 lg:p-8 gap-1 border-accentsecond">
            ...
            <h1 class="text-sm md:text-base lg:text-2xl text-primary font-medium leading-snug">
    ...
    <div class="w-full md:w-1/2 flex flex-col" x-data="{ sent: {{ session('success') ? 'true' : 'false' }} }">
        ...
        <div class="bg-background border-2 border-accentsecond">
            <form action="{{ route('contact.send') }}" id="contact-form" method="POST" class="flex flex-col">
                @csrf
                <div data-aos="fade-up"
                    class="flex flex-col justify-center border-b-2 border-accentsecond w-full p-4 md:p-5 lg:p-8 gap-2">
                ...
                <div data-aos="fade-up" class="flex flex-col justify-center w-full p-4 md:p-5 lg:p-8 gap-2">
        ...
        <div data-aos="custom-zoom-in-up" class="mt-5 md:mt-6">
            <button type="submit" form="contact-form"
                class="bg-secondary relative group overflow-hidden text-background w-full md:w-full lg:w-44 h-12 flex items-center justify-center cursor-pointer rounded-full shadow-md transition ease-in-out duration-500">
                <span
